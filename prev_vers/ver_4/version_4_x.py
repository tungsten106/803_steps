...
def draw_erode(mouse_x, mouse_y):
    ...
    if not mouse_pressed and dilate_index <= max_erode:
        window.update()
        window.after(30, lambda: draw_erode(mouse_x, mouse_y))
    else:
...
max_sq_size = int(canvas_width // 2)  # 图片扩大最大尺寸
init_sq_size = 10
poly_n = 15
